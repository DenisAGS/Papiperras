...
import { DaniService } from '../services/dani.service';
...
export class GraficabarrasComponent implements OnInit {
  ...
  constructor(private daniService: DaniService) { }

  ngOnInit(): void {
    this.daniService.getDani().subscribe(datos => {
      this.datos = datos;
  ...
  getRandomColor(i: number): string {
    ...
    switch (colorIndex) {
      case 0:
        return 'rgb(128, 10, 128)';   // Púrpura
      case 1:
        return 'rgb(10, 0, 128)';     // Azul
      case 2:
        return 'rgb(128, 0, 0.2)';     // Rojo
      case 3:
        return 'rgb(128, 128, 0.2)';   // Amarillo
      case 4:
        return 'rgb(0, 128, 0.2)';     // Verde
      case 5:
        return 'rgb(128, 12, 0.2)';   // Cian
      case 6:
        return 'rgb(120, 100, 128)'; // Gris
      default:
